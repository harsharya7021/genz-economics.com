...
date: 2025-09-05
tags: [gst, fiscal-policy, india, keynesian, tantri-files]
excerpt_override: "A polished mini-essay Tantri sent into the WhatsApp group on the day the GST rate cuts were announced — drawing the short-run/long-run distinction that almost nobody on TV gets right."
authors:
  - tantri
editors:
  - harsh
...
**For background on the underlying Keynesian framework Tantri is drawing on**, see [Session 5 — Fiscal Policy, Crowding Out & Transmission](/2025/11/is-lm-framework-and-fiscal-policy/) and [Session 1 — Economy in the Long Run](/2025/10/economy-in-the-long-run/).
