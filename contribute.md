...
layout: page
title: Contribute
dek: Three ways to help. Two of them take under a minute.
...
1. Fork the repo.
2. Add a new markdown file under `_posts/` with the naming `YYYY-MM-DD-your-slug.md`.
3. Use the post template at `_posts/_TEMPLATE.md`.
