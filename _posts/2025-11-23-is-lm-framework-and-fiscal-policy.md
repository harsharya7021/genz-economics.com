---
layout: post
title: "Fiscal Policy, Crowding Out & Transmission"
dek: "GST cuts, the crowding-out debate, the five-step transmission mechanism, and the AI-human-capital question for India."
date: 2025-11-23
session: 5
tags: [fiscal-policy, crowding-out, transmission, gst, human-capital, india]
excerpt_override: "Session 4 — the GST tax-cut case, government borrowing and crowding out, a five-step transmission walkthrough, and AI/human capital."
authors:
  - harsh
editors: []
...
## **When Central Bank Doesn't Accommodate**
  ...
  - ## Central bank holds money supply constant
...
> 
> • The slope of Aggregate Demand is C<sub>1</sub> (MPC, where C<sub>1</sub> < 1) *— also called the fiscal multiplier*
> 
