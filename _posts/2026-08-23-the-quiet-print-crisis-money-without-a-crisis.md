...
dek: "In the year to 31 July 2026, deposits with Indian banks grew ₹36 lakh crore while nominal GDP grew about ₹20 lakh crore. Add cash and the money in the system is touching 90% of GDP — a level this economy visits during a crisis. There is no crisis. Nobody at Mint Street is discussing it, and the alibi for the inflation that may follow — Trump, oil, fertiliser — is being written in advance. This session teaches you to read the two RBI tables where the truth sits."
date: 2026-08-23
session: 19
tags: [money-supply, rbi, crr, liquidity, inflation, india, japan]
excerpt_override: "Session 19 — open the RBI's own PDF and count: deposits 238 → 274 lakh crore in a year, cash back to 12% of GDP, total money ~316 against a ~350 GDP. Five machines — the WSS race, the multiplier machine, the tap and the sponge, the 90% path, the Keynes–Friedman switchboard — plus the week Japan's carry unwind went from theory to a photographed to-do list."
authors:
  - harsh
editors: []
description: "Prof. Tantri reads the RBI's Section 42 return and WSS line by line: ₹36 lakh crore of new deposits, a CRR cut from 4% to 3%, OMOs financing state borrowing, and money-to-GDP touching 90% — with interactive models and the Bloomburger Money Printer."
---
...
Which produced the spectacle of the year. In late July–early August, Japan and the US ran the **first joint yen-buying intervention since 1998** — Tokyo deploying something like **$60–70 billion**, Washington a token slice. How do we know Washington's number? Because Treasury Secretary Bessent brought a handwritten note to a Camp David cabinet meeting, a photographer's zoom lens did the rest, and the world read his to-do list: *"To Do: Buy Japanese Yen $5–10 bil."* ([CNBC](https://www.cnbc.com/2026/08/03/yen-intervention-us-japan-trump-bessent-katayama.html), [The Japan Times](https://www.japantimes.co.jp/business/2026/08/03/markets/japan-us-joint-yen-intervention/), [Axios](https://www.axios.com/2026/08/03/yen-japan-treasury-bessent) — and the class's point: the US is not being charitable; it is buying yen so that Japan does not raise yen by **dumping Treasuries** into a fragile market.) The yen moved from ~163 to ~158. Stabilised, for now. The underlying cause — Japanese households finally repricing their own money — has not gone anywhere.
...
**Row 8, bank credit: ₹185 → ₹225 lakh crore.** Loans create deposits — [the money side of the Keynesian plumbing]({% post_url 2025-10-19-the-keynesian-cross %}) — so both sides of the sheet swelled together.
...
<div class="widget" id="s19-tap">
  ...
  <p class="w-big" data-verdict></p>
  <p class="w-note" data-note>Primary liquidity is reserve money — the input. Deposits are the output, primary × multiplier. Slide until implied meets actual: the multiplier that reconciles them is the machine from Model №2, running at full song. (The swap's absorption is pre-booked for 2029 — the sponge with a due date.)</p>
</div>
